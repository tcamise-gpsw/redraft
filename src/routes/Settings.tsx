      ...
      <>
        <header className="space-y-3">
          ...
          <p className="text-sm text-slate-300">
            You&apos;re using ReDraft in local mode. Connect to a GitHub
            repository from the command line to unlock remote review features.
          </p>
        </header>
        <section className="flex items-center gap-4 rounded-xl border border-slate-800 bg-slate-950/50 p-4">
          ...
          <div>
            <p className="text-sm text-slate-400">Serving as</p>
